...
import { bubbleSort, insertionSort, mergeSort, quickSort } from './SortingVisualizers/SortVisualizer'
    ...
    <div>
      ...
      <div className="bottom-container">
        ...
        <div className="sorting-container">
          ...
          <div className="sorting-btns-container">
            <button onClick={() => mergeSort(animSpeedMillis, array.slice(), timeouts)} className="btn sort-btn">Merge Sort</button>
            <button onClick={() => quickSort(animSpeedMillis, array.slice(), timeouts)} className="btn sort-btn">Quick Sort</button>
          </div>
        </div>
